...
const UpdateProfileName = () => {
  ...
  const [newName, setNewName] = useState("Adam")

 // when you click the update button (logic)
      ...
      <div className="row align-items-center g-lg-5 py-5">
        ...
        <div className="col-md-10 mx-auto col-lg-5">
          <form className="p-4 p-md-5 border rounded-3 bg-light">
            ...
            <button onClick={onClickUpdate} className="w-100 btn btn-lg btn-primary" type="submit">
              Update
            </button>
            <hr className="my-4" />
